...
<header class="header-section">
    <div class="container">
        <div class="logo">
            <a href="./index.html">
                <h3><b style="color:white";> KY</b><b style="color: #ff471a;">GYM</b></h3>
            </a>
        </div>
        <div class="nav-menu">
...
<section class="hero-section">
    <div class="hero-items owl-carousel">
        <div class="single-hero-item set-bg" data-setbg="{{asset('assets/img/slider-bg-1.jpg')}}">
            <div class="jumbotron-fluid">
                <div class="hero-text" style=" ">
                    <div class="container">
                        <h4><span  style="border:2px solid white;">Body Fitness Gym</span></h4>
        ...
        <div class="single-hero-item set-bg" data-setbg="{{asset('assets/img/slider-bg-2.jpg')}}">
            <div class="container">
                <div class="hero-text">
                    <h4><span  style="border:2px solid white;">Body Fitness Gym</span></h4>
                    <h1>Make Yourself<span> Fighter</span></h1>
                    <a href="#" class="primary-btn">Join Us Now</a>
                </div>
            </div>
        </div>
        <div class="single-hero-item set-bg" data-setbg="{{ asset('assets/img/slider-bg-3.jpg') }}">
            <div class="container">
                <div class="hero-text">
                    <h4><span  style="border:2px solid white;">Body Fitness Gym</span></h4>
                    <h1>Make Yourself<span> Fighter</span></h1>
...
<!-- Cta Section Begin -->
<section class="cta-section set-bg spad" data-setbg="{{asset('assets/img/cta-bg.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade-in active" id="class-1" role="tabpanel">
                                    <div class="single-class-item">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="{{asset('assets/img/class/class-1.jpg')}}" alt="">
                                            </div>
                                            <div class="col-lg-5 offset-lg-1">
                            ...
                            <ul class="nav" role="tablist">
                                <li>
                                    <a data-toggle="tab" class="active" href="#class-1" role="tab">
                                        <div class="author-text">
                                            <img src="{{asset('assets/img/class/author-1.jpg')}}" alt="">
                                            <h5>Body building</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#class-2" role="tab">
                                        <div class="author-text">
                                            <img src="{{asset('assets/img/class/author-2.jpg')}}" alt="">
                                            <h5>Racing runing</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#class-3" role="tab">
                                        <div class="author-text">
                                            <img src="{{asset('assets/img/class/author-3.jpg')}}" alt="">
                                            <h5>Yoga Fitness</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#class-4" role="tab">
                                        <div class="author-text">
                                            <img src="{{asset('assets/img/class/author-4.jpg')}}" alt="">
                                            <h5>Kick boxing</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#class-5" role="tab">
                                        <div class="author-text">
                                            <img src="{{asset('assets/img/class/author-5.jpg')}}" alt="">
                                ...
                                <li>
                                    <a data-toggle="tab" href="#class-6" role="tab">
                                        <div class="author-text">
                                            <img src="{{asset('assets/img/class/author-6.jpg')}}" alt="">
                                            <h5>Martial Arts</h5>
                                        </div>
                                    </a>
                                </li>
...
<section class="trainer-schedule set-bg spad" data-setbg="{{asset('assets/img/trainer-bg.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
            ...
            <div class="row m-0">
                <div class="col-lg-4 order-lg-1 p-0">
                    <div class="member-pic first">
                        <img src="{{asset('assets/img/trainer-1.jpg')}}" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-4 order-lg-3 p-0">
                    <div class="member-pic second">
                        <img src="{{asset('assets/img/trainer-2.jpg')}}" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-4 order-lg-5 p-0">
                    <div class="member-pic third">
                        <img src="{{asset('assets/img/trainer-3.jpg')}}" alt="">
                    </div>
                </div>
