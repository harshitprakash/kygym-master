...
{{--                </div>--}}
                <ul class="navbar-nav header-left">
                    <li class="nav-item dropdown">
                        <div class="input-group nav-link search-area d-xl-inline-flex d-none">
...
{{--                    </li>--}}
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <img src="{{ asset('images/profile/users/'.Auth::user()->info->image) }}" width="20" alt="{{ Auth::user()->first_name.' '.Auth::user()->last_name }}">
                            <div class="header-info">
                                <span class="text-black"><strong>  {{ ucfirst(Auth::user()->first_name).' '.ucfirst(Auth::user()->last_name) }}</strong></span>
                                <p class="fs-12 mb-0">{{ Auth::user()->info->roleDetail->role }}</p>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('profile.view', \Illuminate\Support\Facades\Crypt::encrypt(Auth::user()->id)) }}" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ml-2">Profile </span>
                            </a>
                            <a href="{{ route('password.update') }}" class="dropdown-item ai-icon" data-toggle="modal" data-target="#change-password">
                               <i class=" fa fa-key text-info"></i>
                                <span class="ml-2">Password Change</span>
                            </a>
