...
<head>
    ...
    <title>Login | Body Fitness Gym | Samaypur</title>
    <!-- Favicon icon -->
...
<body class="h-100" style="background-image: url('{{ asset('images/background/login.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
