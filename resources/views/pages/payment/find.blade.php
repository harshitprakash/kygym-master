...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">View Member</a></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-12">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (key, value) {
                            ...
                            $('#ShowResult').empty().append('<tr><td>' + value.member_id + '</td><td>' + value.first_name + " " + value.last_name + '</td><td>'+ value.email +'</td><td><a href="/admin/user/fee/'+ value.id +'" class="btn btn-sm btn-primary">Select</a></td></tr>');
                        })
                    }
                })
            });
