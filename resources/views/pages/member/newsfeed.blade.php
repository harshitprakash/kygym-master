            ...
            <div class="row">
                <div class="col-xl-12 col-md-6">
                    <div class="card flex-xl-column flex-md-row flex-column">
                        <div class="card-body profile px-3 pt-3 pb-0 mb-2">
                            <div class="profile-head d-flex align-content-center">
                                <div class="profile-photo">
                                    <img src="{{ asset('images/greetings/gym.png') }}"
                                         class="img-fluid rounded-circle mt-5" alt="GreetingImage">
                                </div>
                                <div class="profile-details">
                                    <div class="profile-name px-3 pt-2 mt-3">
                                        <h4 class="text-secondary mb-0">
                                            <strong>Good {{ ucfirst($greeting).', '.$member->first_name }}</strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body p-2">
                            <div class="d-flex align-items-center p-4">
                                <img src="{{ asset('images/profile/users/'.$member->info->image) }}" width="70"
                                     class="img-fluid rounded-circle"
                                     alt="{{ $member->first_name.' '.$member->last_name }}">
                                <div>
                                    <h4 class="fs-24 text-black mb-0">
                                        <strong>{{ ucfirst($member->first_name).' '.ucfirst($member->last_name) }}</strong>
                                    </h4>
                                    <span class="fs-12">{{ $member->info->roleDetail->role }}</span>
                                </div>
                            </div>
                                ...
                                <div class="profile-personal-info">
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500"><i class="fa fa-crosshairs"></i> <span
                                                    class="pull-right">:</span>
                                            </h5>
                                        </div>
                                        <div class="col-sm-9 col-7">
                                            <span>{{ ucfirst($member->info->roleDetail->role) }}</span>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500"><i class="fa fa-venus-mars"></i> <span
                                                    class="pull-right">:</span>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500"><i class="fa fa-phone"></i> <span
                                                    class="pull-right">:</span>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500"><i class="fa fa-birthday-cake"></i> <span
                                                    class="pull-right">:</span>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                            <h5 class="f-w-500"><i class="fa fa-map-marker"></i> <span
                                                    class="pull-right">:</span>
                                            </h5>
                                        </div>
                                        <div class="col-sm-9 col-7">
                                            <span>{{ $member->info->address.', '.$member->info->city.', '.$member->info->state.' - '.$member->info->pin_code }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-12 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body loadmore-content height340 dz-scroll height pb-4 pt-0"
                      ...
                      <defs>
                        <clipPath id="clip3">
                          <rect width="24" height="24" fill="white"/>
                                ...
                                <div>
                                    <h6 class="font-w600 fs-16 mb-0"><a href="personal-record.html" class="text-black">Sunday
                                            Running</a></h6>
                      ...
                      <defs>
                        <clipPath id="clip4">
                          <rect width="24" height="24" fill="white"/>
                                ...
                                <div>
                                    <h6 class="font-w600 fs-16 mb-0"><a href="personal-record.html" class="text-black">Saturday
                                            Running</a></h6>
                                    <span class="fs-12">2km distances</span>
                                </div>
                                <a href="personal-record.html" class="ml-auto">
                      ...
                      <defs>
                        <clipPath id="clip5">
                          <rect width="24" height="24" fill="white"/>
                                ...
                                <div>
                                    <h6 class="font-w600 fs-16 mb-0"><a href="personal-record.html" class="text-black">Friday
                                            Cycling</a></h6>
                                    <span class="fs-12">2km distances</span>
                                </div>
                                <a href="personal-record.html" class="ml-auto">
                      ...
                      <defs>
                        <clipPath id="clip6">
                          <rect width="24" height="24" fill="white"/>
                                ...
                                <div>
                                    <h6 class="font-w600 fs-16 mb-0"><a href="personal-record.html" class="text-black">Monday
                                            Running</a></h6>
                                    <span class="fs-12">2km distances</span>
                                </div>
                                <a href="personal-record.html" class="ml-auto">
                        ...
                        <div class="card-footer style-1 text-center border-0 pt-0 pb-4">
                            <a class="text-primary dz-load-more fa fa-chevron-down" id="recentActivities"
                               href="javascript:void(0);" rel="ajax/recent-activities.html">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-12">
                    @if(count($post)>0)
                        @foreach($post as $key=>$data)
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex" id="ImageData">
                                        @foreach(json_decode($data->Image->name, true) as $img)
                                            <a href="{{ asset('images/post/'.$img) }}"
                                               data-exthumbimage="{{ asset('images/post/'.$img) }}"
                                               data-src="{{ asset('images/post/'.$img) }}"><img
                                                    src="{{ asset('images/post/'.$img) }}" alt="" class="img-fluid"></a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="card-footer d-md-flex d-block pb-0 border-0">
                                    <div class="mr-2 mb-md-0 mb-3">
                                        <h4 class="text-black fs-20">{{ $data->title }}</h4>
                                        <p class="fs-13 mb-0">{{ $data->description }}</p>
                                    </div>
                                    <div class="d-flex flex-wrap align-items-center">
                                        <div class="custom-control check-switch custom-checkbox mr-4 mb-2">
                                            <label class="custom-control-label" for="customCheck9">Like</label>
                                        </div>
                                        <div class="custom-control custom-switch toggle-switch text-right mr-4 mb-2">
                                            <label class="custom-control-label" for="customSwitch11">Report</label>
                                        </div>
                                    </div>
                                </div>
                                <br>
                    ...
                    @else
                        <div class="card-footer d-md-flex d-block pb-0 border-0">
                            <div class="container-fluid">
                                <h4 class="text-danger fs-20 text-center">No Posts are available to display!.</h4>
                            </div>
                        </div>
                    @endif
                </div>
