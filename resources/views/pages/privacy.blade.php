...
<head>
    ...
    <title>KY GYM - Privacy Policy</title>
</head>
<body>
<div class="container">
    <h1>Ky Gym Privacy Policy</h1>
    ...
    <ul>
        ...
        <li>
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any
                electronic device, named Body Fitness Gym</p>
        </li>
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Body Fitness Gym (KY Gym).</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Body Fitness Gym (KY Gym), accessible from <a
                    href="http://bodyfitness.kygym.in" rel="external nofollow noopener" target="_blank">http://bodyfitness.kygym.in</a>
            </p>
        </li>
        <li>
    ...
    <ul>
        <li>
            <p>By email: contact@kygym.in</p>
        </li>
        <li>
            <p>By visiting this page on our website: <a href="http://bodyfitness.kygym.in/contact"
                                                        rel="external nofollow noopener" target="_blank">http://bodyfitness.kygym.in/contact</a>
            </p>
        </li>
        <li>
            <p>By phone number: +917982700500</p>
        </li>
    </ul>
</div>
</body>
