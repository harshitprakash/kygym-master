...
@section('title','Approve Diet Plan')
@section('custom-css')
...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Approve & Collect.</a></li>
        </ol>
    </div>
    <div class="row">
                    ...
                    <div class="card plan-list">
                        <div class="card-header d-sm-flex flex-wrap d-block pb-0 border-0">
                            <div class="mr-auto pr-3 mb-3">
                                <h4 class="text-black fs-20">Union Territory</h4>
                                <p class="fs-13 mb-0 text-black">Basic Description</p>
                            </div>
                ...
                <div class="col-xl-12 mt-2">
                    <div class="card flex-xl-column flex-md-row flex-column">
                        <div class="card-body">
                            <div class="mt-0 text-center">
                                <h4 class="text-primary mb-4">
                                    <strong>Package Price & Information</strong>
                                </h4>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6 col-6">
                                    <span><strong>999 Rupees</strong></span>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-6 col-6">
